...
echo "============================================================"
echo "G1 Task4 Sim2Real Robustness Env Test"
echo "PROJECT_ROOT=${PROJECT_ROOT}"
echo "PYTHON=$(which python)"
echo "G1_USD_PATH=${G1_USD_PATH:-<default from Task4Config>}"
echo "G1_TASK4_MOTION_FILE=${G1_TASK4_MOTION_FILE:-<default from Task4Config / fallback G1_TASK2_MOTION_FILE>}"
echo "G1_TASK2_MOTION_FILE=${G1_TASK2_MOTION_FILE:-<none>}"
echo "============================================================"
...
python tests/task4/task4_env_test.py \
  ...
  ${G1_TASK4_MOTION_FILE:+--motion-file "$G1_TASK4_MOTION_FILE"}
