...
$RunName = "win_g1_task2_eval_" + (Get-Date -Format "yyyyMMdd_HHmmss")
$DriverLog = Join-Path $DriverLogRoot ($RunName + "_driver.log")

Write-Host ""
Write-Host "============================================================"
Write-Host "G1 Task2 Windows skrl PPO model evaluation runner"
Write-Host "============================================================"
...
Write-Host ""
Write-Host "============================================================"
Write-Host "G1 Task2 Windows model eval finished with exit code: $exitCode"
