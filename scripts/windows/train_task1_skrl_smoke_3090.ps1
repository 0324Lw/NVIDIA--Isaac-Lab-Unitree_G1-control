...
if ([string]::IsNullOrWhiteSpace($RunName)) {
    $RunName = "win_g1_task1_smoke_" + (Get-Date -Format "yyyyMMdd_HHmmss")
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host "G1 Task1 Windows RTX 3090 skrl PPO SMOKE runner"
Write-Host "============================================================"
Write-Host "This script WILL launch tiny G1 Task1 training only when approved."
...
if ($env:G1_TASK1_WINDOWS_SMOKE_APPROVED -ne "1") {
    Write-Host ""
    Write-Host "[STOP] To actually start G1 Task1 smoke training, run first:" -ForegroundColor Yellow
    Write-Host '  $env:G1_TASK1_WINDOWS_SMOKE_APPROVED = "1"'
    Write-Host ""
    exit 0
}
...
Write-Host ""
Write-Host "============================================================"
Write-Host "G1 Task1 Windows smoke finished with exit code: $exitCode"
